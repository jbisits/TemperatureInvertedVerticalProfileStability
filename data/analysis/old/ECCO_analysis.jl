...
series = RasterSeries(ECCO_data[1:2], Ti(timestamps[1:2]); child = RasterStack)
...
## Compute max denisty difference for given ΔΘ_thres range and extract data to plot
ΔΘ_thres = [1.0, 2.0]
Δρ_max_series = series_max_Δρ(series, ΔΘ_thres)
